...
# set terminal pdfcairo  transparent enhanced font "Verdana,16" fontscale 0.5 size 5.00in, 3.00in 
# set output 'prova.pdf'
unset clip points
set clip one
unset clip two
...
set title "Photonic Density of States" 
